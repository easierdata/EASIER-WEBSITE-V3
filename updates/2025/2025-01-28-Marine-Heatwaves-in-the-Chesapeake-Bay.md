...
Building upon these decentralized technologies, [DeSci Labs](https://desci.com) has developed a fully open science framework that leverages the power of decentralized systems. This framework aims to transform how scientific research is conducted, shared, and preserved throughout the entire research lifecycle. We've gone ahead and published the source code from this study onto DeSci node, making it accessible to the broader scientific community. You can access the source code [here](https://nodes.desci.com/dpid/327).
